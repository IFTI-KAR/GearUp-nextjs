...
export default function PaymentSuccessPage() {
  ...
  return (
    <div className="max-w-lg mx-auto px-4 py-16 text-center space-y-6">
      <div className="glass-panel p-8 sm:p-10 rounded-3xl border border-slate-800 space-y-6 shadow-2xl shadow-emerald-950/30">
        ...
        <div className="space-y-1">
          <span className="text-xs font-bold uppercase tracking-widest text-emerald-400">Transaction Approved</span>
          <h1 className="text-2xl font-black text-white">Payment Successful!</h1>
          <p className="text-xs text-slate-400">Your rental equipment order has been confirmed and paid.</p>
        </div>
        ...
        {order && (
          <div className="p-4 rounded-2xl bg-slate-900/80 border border-slate-800 text-left space-y-2 text-xs">
            ...
            <div className="flex justify-between text-slate-400">
              ...
              <span className="font-mono text-emerald-400 font-bold">{paymentId}</span>
            </div>
            <div className="flex justify-between text-slate-400">
              <span>Gateway:</span>
            ...
            <div className="flex justify-between text-slate-400">
              <span>Item:</span>
              <span className="font-bold text-white truncate max-w-[180px]">{order.gearTitle}</span>
            </div>
        ...
        <div className="pt-2 space-y-3">
          ...
          <Link
            href="/gear"
            className="block text-xs font-bold text-slate-400 hover:text-white transition"
          >
